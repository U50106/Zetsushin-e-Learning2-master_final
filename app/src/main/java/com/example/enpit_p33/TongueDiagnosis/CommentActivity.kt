...
class   CommentActivity : AppCompatActivity() {
    ...
    private val MC = ViewGroup.LayoutParams.MATCH_PARENT
    ...
    fun comment(linearLayout: LinearLayout) {
        ...
        val wid = realSize.x / 130
        val hei = realSize.y / 130

        val size_change : Float = 1f / wid * 5
        ...
        inlinearLayout_1.addView(title, LinearLayout.LayoutParams(WC, WC))
        ...
        inlinearLayout_1.addView(question_statement, LinearLayout.LayoutParams(WC, WC))

        val separate_1 = View(this)
        separate_1.background = back
        inlinearLayout_1.addView(separate_1, LinearLayout.LayoutParams(150*wid, 5))
        ...
        for (num in Array(miss_ans.size, { i -> i })) {
            ...
            inlinearLayout_2_1.addView(space_2_1_1, LinearLayout.LayoutParams(10*wid, 5*hei))
            ...
            inlinearLayout_2_1.addView(text_2_1_1, LinearLayout.LayoutParams(WC, WC))

            val space_2_1_2 = Space(this)
            inlinearLayout_2_1.addView(space_2_1_2, LinearLayout.LayoutParams(10*wid, 5*hei))
            ...
            inlinearLayout_3_1.addView(state_1, LinearLayout.LayoutParams(MC, WC))
            ...
            inlinearLayout_3_1.addView(imageView_1,LinearLayout.LayoutParams(30*wid, 30*hei))
            ...
            inlinearLayout_3_2.addView(space_3_2_1, LinearLayout.LayoutParams(2*wid, 2*hei))
            ...
            inlinearLayout_3_2.addView(text_1, LinearLayout.LayoutParams(MC, WC))
            ...
            inlinearLayout_3_2.addView(imageView_2, LinearLayout.LayoutParams(10*wid, 5*hei))
            ...
            inlinearLayout_3_3.addView(state_2, LinearLayout.LayoutParams(MC, WC))
            ...
            inlinearLayout_3_3.addView(imageView_3, LinearLayout.LayoutParams(30*wid, 30*hei))

            inlinearLayout_3.addView(inlinearLayout_3_3, param)

            val space_3_1 = Space(this)
            inlinearLayout_3.addView(space_3_1, LinearLayout.LayoutParams(2*wid, 2*hei))
...
///*
            ...
            text_3_4_1.text = color[miss[num].substring(0,1).toInt() - 1] + "の特徴的な色"
            text_3_4_1.textSize = 32.0f * size_change
            text_3_4_1.gravity = Gravity.CENTER
            inlinearLayout_3_4.addView(text_3_4_1, LinearLayout.LayoutParams(MC, WC))
//*/
...
///*
            ...
            inlinearLayout_3_4_1.addView(imageButton_3_4_1_1, LinearLayout.LayoutParams(10*wid, 10*hei))
...
//            val r_3_4_1_2 = resources.getIdentifier("t1_1_2_1_1", "drawable", packageName)
            ...
            inlinearLayout_3_4_1.addView(imageButton_3_4_1_2, LinearLayout.LayoutParams(10*wid, 10*hei))
            ...
            inlinearLayout_3_4_2.addView(imageButton_3_4_2_1, LinearLayout.LayoutParams(10*wid, 10*hei))
            ...
            inlinearLayout_3_4_2.addView(imageButton_3_4_2_2, LinearLayout.LayoutParams(10*wid, 10*hei))
            ...
            inlinearLayout_3_4_3.addView(space_3_4_3_1, LinearLayout.LayoutParams(5*wid, 5*hei))

            val button_3_4_3_1 = Button(this)
            button_3_4_3_1.text = "全色表示"
            button_3_4_3_1.textSize = 32.0f * size_change
            inlinearLayout_3_4_3.addView(button_3_4_3_1, LinearLayout.LayoutParams(WC, WC))
...
//*/
            ...
            inlinearLayout_4_1.addView(state_3, LinearLayout.LayoutParams(MC, WC))
            ...
            inlinearLayout_4_1.addView(imageView_5, LinearLayout.LayoutParams(30*wid, 30*hei))
            ...
            inlinearLayout_4_2.addView(space_4_2_1, LinearLayout.LayoutParams(2*wid, 2*hei))
            ...
            inlinearLayout_4_2.addView(text_2, LinearLayout.LayoutParams(MC, WC))
            ...
            inlinearLayout_4_2.addView(imageView_6, LinearLayout.LayoutParams(10*wid, 5*hei))
            ...
            inlinearLayout_4_3.addView(state_4, LinearLayout.LayoutParams(MC, WC))
            ...
            inlinearLayout_4_3.addView(imageView_7, LinearLayout.LayoutParams(30*wid, 30*hei))

            inlinearLayout_4.addView(inlinearLayout_4_3, param)

            val space_4_1 = Space(this)
            inlinearLayout_4.addView(space_4_1, LinearLayout.LayoutParams(2*wid, 2*hei))
...
///*
            ...
            text_4_4_1.text = miss_ans[num] + "の特徴的な色"
            text_4_4_1.textSize = 32.0f * size_change
            text_4_4_1.gravity = Gravity.CENTER
            inlinearLayout_4_4.addView(text_4_4_1, LinearLayout.LayoutParams(MC, WC))
//*/
...
///*
            ...
            inlinearLayout_4_4_1.addView(imageButton_4_4_1_1, LinearLayout.LayoutParams(10*wid, 10*hei))
...
//                val r = resources.getIdentifier("q1_1", "drawable", packageName) //drawableの画像指定
            ...
            inlinearLayout_4_4_1.addView(imageButton_4_4_1_2, LinearLayout.LayoutParams(10*wid, 10*hei))
...
//                val r = resources.getIdentifier("q2_1", "drawable", packageName) //drawableの画像指定
            ...
            inlinearLayout_4_4_2.addView(imageButton_4_4_2_1, LinearLayout.LayoutParams(10*wid, 10*hei))
            ...
            inlinearLayout_4_4_2.addView(imageButton_4_4_2_2, LinearLayout.LayoutParams(10*wid, 10*hei))
...
//                val r = resources.getIdentifier("q4_1", "drawable", packageName) //drawableの画像指定
            ...
            inlinearLayout_4_4_3.addView(space_4_4_3_1, LinearLayout.LayoutParams(10*wid, 10*hei))

            val button_4_4_3_1 = Button(this)
            button_4_4_3_1.text = "全色表示"
            button_4_4_3_1.textSize = 32.0f * size_change
            inlinearLayout_4_4_3.addView(button_4_4_3_1, LinearLayout.LayoutParams(WC, WC))
...
//*/
            ...
            inlinearLayout_5.addView(space_5_1, LinearLayout.LayoutParams(50*wid, 5*hei))
            ...
            inlinearLayout_5.addView(text_3, LinearLayout.LayoutParams(MC, WC))
            ...
            inlinearLayout_5.addView(imageView_9, LinearLayout.LayoutParams(5*wid, 10*hei))
            ...
            linearLayout.addView(separate_2, LinearLayout.LayoutParams(150*wid, 5))
        }
    }
